...
public class ModuleInfo {
    ...
    public static final int MIN_ORCA_VERSION = 313002715;
    public static final int MAX_ORCA_VERSION = 313202299;
    public static final String RECOMMENDED_ORCA_VERSION_STRING = "416";
}
