...
class OnMessageActionRunner : TaskerPluginRunnerConditionEvent<OnMessageInput, OnMessageOutput, OnMessageUpdate>() {
    override fun getSatisfiedCondition(context: Context, input: TaskerInput<OnMessageInput>, update: OnMessageUpdate?): TaskerPluginResultCondition<OnMessageOutput> {
        ...
        val senderThreadKey = update?.senderThreadKey ?: -1L;
...
class OnMessageOutput constructor(
        ...
        @get:TaskerOutputVariable("last_message_sender_threadkey", R.string.last_message_sender_threadkey, R.string.last_message_sender_threadkey_description) val senderThreadKey: Long,
...
class OnMessageUpdate @JvmOverloads constructor(
        ...
        @field:TaskerInputField("sender_threadkey") var senderThreadKey: Long? = null,
...
class ActivityOnMessageConfig : Activity(), TaskerPluginConfig<OnMessageInput> {
    ...
    companion object {
        @JvmStatic
        fun triggerMessageReceived(context: Context, message: String, messageId: String, senderThreadKey: Long, convThreadKey: Long) =
